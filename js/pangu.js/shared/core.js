...
class Pangu {
  ...
  spacing(text) {
    ...
    newText = newText.replace(DOTS_CJK, `$1${this.space}$2`);
    newText = newText.replace(FIX_CJK_COLON_ANS, `$1：$2`);

    newText = newText.replace(CJK_QUOTE, `$1${this.space}$2`);
    newText = newText.replace(QUOTE_CJK, `$1 $2`);
    newText = newText.replace(FIX_QUOTE_ANY_QUOTE, `$1$2$3`);

    newText = newText.replace(CJK_SINGLE_QUOTE_BUT_POSSESSIVE, `$1${this.space}$2`);
    newText = newText.replace(SINGLE_QUOTE_CJK, `$1${this.space}$2`);
    newText = newText.replace(FIX_POSSESSIVE_SINGLE_QUOTE, "$1`s"); // eslint-disable-line quotes

    newText = newText.replace(HASH_ANS_CJK_HASH, `$1${this.space}$2$3$4${this.space}$5`);
    newText = newText.replace(CJK_HASH, `$1${this.space}$2`);
    newText = newText.replace(HASH_CJK, `$1${this.space}$3`);

    newText = newText.replace(CJK_OPERATOR_ANS, `$1${this.space}$2${this.space}$3`);
    newText = newText.replace(ANS_OPERATOR_CJK, `$1${this.space}$2${this.space}$3`);

    newText = newText.replace(FIX_SLASH_AS, `$1$2`);
    newText = newText.replace(FIX_SLASH_AS_SLASH, `$1$2$3`);

    newText = newText.replace(CJK_LEFT_BRACKET, `$1${this.space}$2`);
    newText = newText.replace(RIGHT_BRACKET_CJK, `$1${this.space}$2`);
    newText = newText.replace(FIX_LEFT_BRACKET_ANY_RIGHT_BRACKET, `$1$2$3`);
    newText = newText.replace(ANS_CJK_LEFT_BRACKET_ANY_RIGHT_BRACKET, `$1${this.space}$2$3$4`);
    newText = newText.replace(LEFT_BRACKET_ANY_RIGHT_BRACKET_ANS_CJK, `$1$2$3${this.space}$4`);

    newText = newText.replace(AN_LEFT_BRACKET, `$1${this.space}$2`);
    newText = newText.replace(RIGHT_BRACKET_AN, `$1${this.space}$2`);

    newText = newText.replace(CJK_ANS, `$1${this.space}$2`);
    newText = newText.replace(ANS_CJK, `$1${this.space}$2`);

    newText = newText.replace(S_A, `$1${this.space}$2`);
